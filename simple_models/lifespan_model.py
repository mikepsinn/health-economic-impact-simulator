class LifespanImpactModel:
    ...
    def calculate_impacts(self, lifespan_increase_pct):
        ...
        # GDP impact (additional productive years)
        productive_years = additional_years * self.workforce_participation
        gdp_impact = productive_years * self.gdp_per_capita
        
        # Healthcare savings (Medicare + private insurance)
        medicare_savings = additional_years * self.medicare_spending
        private_insurance_savings = additional_years * (self.medicare_spending * 0.8)  # Estimate private insurance costs
        
        # Social security impact (delayed payouts)
        social_security_savings = additional_years * 15000  # Average annual SS benefit
